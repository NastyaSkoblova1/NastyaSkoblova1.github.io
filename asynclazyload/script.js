    ...
    $(".r").not('[data-t263-block-notslide=yes]').each(function (i) {
        ...
        if (cur == i) {
            ...
            el.animate({
                ...
                $('.t223, .t498').trigger('displayChanged');
                if (window.lazy == 'y') {
                    t_lazyload_update()
                }
            });
...
function t967_highlight() {
    ...
    $(".t967__list_item a[href='" + url + "']").addClass("t-active");
    $(".t967__list_item a[href='" + url + "/']").addClass("t-active");
    $(".t967__list_item a[href='" + pathname + "']").addClass("t-active");
    $(".t967__list_item a[href='/" + pathname + "']").addClass("t-active");
    $(".t967__list_item a[href='" + pathname + "/']").addClass("t-active");
    $(".t967__list_item a[href='/" + pathname + "/']").addClass("t-active")
}
...
function t967_checkAnchorLinks(recid) {
    if ($(window).width() >= 960) {
        var navLinks = $("#rec" + recid + " .t967__desktoplist .t967__list_item a:not(.tooltipstered)[href*='#']");
        if (navLinks.length > 0) {
            catchScroll(navLinks)
        }
    }
}
...
function t967_catchScroll(navLinks) {
    ...
    updateSectionsOffsets(sections);
    sections.sort(function (a, b) {
        return b.attr("data-offset-top") - a.attr("data-offset-top")
    });
    $(window).bind('resize', t_throttle(function () {
