...
function t_sldsInit(rec, sliderOptions) {
	...
	if (lastSlide && sliderRec.querySelectorAll('.t-slds__item[data-slide-index="0"]').length == 0) {
	...
	if (
		firstSlide &&
		sliderRec.querySelectorAll('.t-slds__item[data-slide-index="' + (totalSlides + 1) + '"]').length == 0
	) {
