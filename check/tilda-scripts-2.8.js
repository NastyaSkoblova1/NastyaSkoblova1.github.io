...
//     else setTimeout(function i() {
//         "function" != typeof window[e] ? setTimeout(i, o || 100) : t()
//     })
// }
...
//                 window.t_lazyload_updateResize_elem(i.find(".t-cover__carrier"))
//             } catch (e) {
//                 console.log("error:" + e)
//             }
//         }
...
//                         e.style.height = n + "px", a.style.height = this.itemHeight + "px", o < i.length - 1 && (r += n), t.push({
//                             node: e,
//                             height: n,
//                             topOffset: this.getAbsoluteTopOffset(e.querySelector(".txt-holder")) - (o == i.length - 1 ? 0 : this.topOffsetShift),
//                             backgroundHolder: a
//                         })
//                     }, this)), t
//                 }.call(this),
...
//                 c || (c = ""), s || (s = ""), d || (d = ""), l || (l = ""), u || (u = ""), p || (p = ""), h || (h = ""), f || (f = ""), p || (p = ""), m || (m = ""), w && "yes" == w && (l = "", u = "", p = ""), !window.isMobile || "" == u && "" == l && "" == p || a.css("background-image", "url('" + c + "')"), setTimeout(function () {
//                         o(t), r(t)
//                     }, 500),
//                     function (e) {
//                         if (i(e)) {
...
//                     }), a.css("background-image", ""), a.css("opacity", "0"), a.css("transition", "opacity 25ms")
//                 }
...
//                 }(a, l, s), u.frameBorder = 0, u.allow = "autoplay", t.appendChild(u), 0 == window.isMobile && new YT.Player(u, {
//                     events: {
//                         onReady: function (o) {
//                             ! function (t, o, i) {
//                                 var r, a = e(window),
...
//                                     s = 0;
//                                 a.scroll(function () {
//                                     r && (window.clearTimeout(r), s >= 15 && (n(c, a, o, i), s = 0), s++), r = window.setTimeout(function () {
//                                         n(c, a, o, i), s = 0
//                                     }, 100)
//                                 }), a.scroll()
...
//             e("div.r[data-screen-max], div.r[data-screen-min]").each(function (n) {
//                 "yes" !== e(this).attr("data-connect-with-tab") && (i = e(this).css("display"), void 0 === (t = e(this).attr("data-screen-max")) && (t = 1e4), t = parseInt(t), void 0 === (o = e(this).attr("data-screen-min")) && (o = 0), (o = parseInt(o)) <= t && (r <= t && r > o ? "block" != i && e(this).css("display", "block") : "none" != i && e(this).css("display", "none")))
//             })
//         }
//         e(document).ready(function () {
...
//             else if (t.width("auto").height(r), (o = (t.width() - i) / 2) < 0 && (o = 0), t.css("left", -o), 0 === o) setTimeout(function () {
...
//                 })
//             }
//             c && a.css("position", "relative"), window.correctFirstTop4Parallax = function () {
//                 a.each(function () {
//                     a.offset().top
//                 })
//             }, window.correctFirstTop4Parallax(), n = r ? function (e) {
//                 return e.outerHeight(!0)
//             } : function (e) {
//                 return e.height()
//             }, (arguments.length < 1 || null === i) && (i = .1), (arguments.length < 2 || null === r) && (r = !0), s(), e(window).resize(window.correctFirstTop4Parallax), t.bind("scroll", s).resize(s), "complete" !== document.readyState && window.addEventListener("load", function () {
//                 s()
//             })
//         }
...
//             }
//             "add" != t && "remove" != t || (r = "/tilda/cart/" + t + "/", l > 0 && (r += "" + l), u > 0 ? r += "-u" + u : p > 0 && (r += "-" + p)), "detail" == t && (r = "/tilda/product/detail/", u > 0 ? r += u + "/" : (l > 0 && (r += "r" + l), p > 0 && (r += "-l" + p))), "purchase" == t && (r = "/tilda/rec" + l + "/payment/"), (h = {
//                 ecommerce: {}
//             }).ecommerce[t] = {
//                 products: d
...
//             }
//             void 0 != window.dataLayer && (n ? r > 0 ? i && i.ecommerce ? window.dataLayer.push(i) : window.dataLayer.push({
//                 event: "pageView",
//                 eventAction: t,
//                 title: o,
//                 value: r,
...
//                                 for (g = 0; g < u; g++) v = i.ecommerce.purchase.products[g], ga("ec:addProduct", {
//                                     id: v.id || g,
//                                     name: v.name,
...
//                                 for (g = 0; g < u; g++) v = i.ecommerce.add.products[g], ga("ec:addProduct", {
//                                     id: v.id || g,
//                                     name: v.name,
//                                     price: parseFloat(v.price).toFixed(2),
//                                     quantity: v.quantity
...
//                                 for (g = 0; g < u; g++) v = i.ecommerce.remove.products[g], ga("ec:addProduct", {
//                                     id: v.id || g,
//                                     name: v.name,
//                                     price: parseFloat(v.price).toFixed(2),
//                                     quantity: v.quantity
...
//                                 for (g = 0; g < u; g++) v = i.ecommerce.detail.products[g], ga("ec:addProduct", {
//                                     id: v.id || g,
//                                     name: v.name,
//                                     price: parseFloat(v.price).toFixed(2),
//                                     quantity: v.quantity
...
//                     r > 0 ? (p.params = {
//                         order_price: r
//                     }, l && (p.params.currency = l), ym(window.mainMetrikaId, "hit", t, p)) : ym(window.mainMetrikaId, "hit", t, p)
//                 } else r > 0 ? (p = {
//                     order_price: r
//                 }, l && (p.currency = l), ym(window.mainMetrikaId, "reachGoal", t, p)) : ym(window.mainMetrikaId, "reachGoal", t);
...
//                     title: o
//                 }) : r > 0 ? window[window.mainMetrika].reachGoal(t, {
//                     title: o,
//                     params: i,
//                     order_price: r
...
//                                 for (g = 0; g < u; g++) v = i.ecommerce.purchase.products[g], w.products.push({
...
//                             for (g = 0; g < u; g++) v = i.ecommerce.add.products[g], w.products.push({
//                                 id: v.id || v.uid || v.name,
//                                 price: v.price ? v.price : 0
//                             }), w.total_price = r;
//                             m = "add_to_cart"
...
//                             w.currency_code = l;
//                             u = i.ecommerce.detail.products.length, h = [];
//                             for (g = 0; g < u; g++) v = i.ecommerce.detail.products[g], w.products.push({
//                                 id: v.id || v.uid || v.name,
//                                 price: v.price ? v.price : 0
//                             }), w.total_price = r;
//                             m = "view_product"
...
//                             for (g = 0; g < u; g++) v = i.ecommerce.remove.products[g], w.products.push({
//                                 id: v.id || v.uid || v.name,
//                                 price: v.price ? v.price : 0
//                             }), w.total_price = r;
//                             m = "remove_from_cart"
...
//                 })
//             }
//             "function" == typeof window.tildastat && (n ? (t.indexOf("payment") > 0 && t.indexOf("tilda/form") > -1 && (t = t.replace("tilda/form", "tilda/rec")), window.tildastat("pageview", {
//                 page: t
