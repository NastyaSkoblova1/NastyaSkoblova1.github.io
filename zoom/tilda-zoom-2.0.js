...
function t_zoomHandler() {
    ...
    var images = $('#' + id).find('.t-zoomable:not(.t-slds__thumbs_gallery):not(.tn-atom__slds-img)');
...
function t_zoom_unscale() {
    ...
    zoomedImage.off('mousemove touchmove').css('left', '').css('top', '').css('max-height', 'calc(100vh - ' + (imageBordersWidth + height) + 'px');
