...
//     if (typeof window.t_menusub_init !== 'undefined') {
//         console.log('Ok');
...
//  if ($.isFunction(window.t_menusub_init)) {
//     console.log('Ok');
// } else {
//     console.log('Error');
// }
...
$('script').each(function() {
    console.log('Script ' + $(this).length);
});

$('article').each(function() {
    console.log('Article ' + $(this).length);
});
                ...
                $('.t-title, .t-name, .t-heading, .t-descr, .t-text, .t-subtitle')
                    ...
                    .each(function (index) {
                        ...
                        if (typeof sta != 'undefined' && sta != '' && sta.indexOf('font-size') > -1) {
                            if ($(this).css('font-size').replace('px', '') > 26) {
                                var newsta = sta.replace('font-size', 'fontsize');
                                /* exclude IP103 block */
                                if (!$(this).hasClass('t673__text')) {
                                    newsta = newsta.replace('line-height', 'lineheight');
                                }
